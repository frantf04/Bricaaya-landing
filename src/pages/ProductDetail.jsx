...
const ProductDetail = () => {
  ...
  useEffect(() => {
    ...
    if (productsData[productId]) {
      ...
      foundVariant = foundProduct.variants.find((v) => v.isDefault) || foundProduct.variants[0]
    } else {
      ...
      <div className="product-detail-content container">
        <div className="product-detail-grid">
          ...
          <div className="product-detail-info">
            {product.isStarProduct && <div className="product-badge">Producto Estrella</div>}
            ...
            <div className="product-price">
              ...
              {product.variants.length > 1 && (
                <span className="price-per-gram">
                  (
                  {(
                    Number.parseFloat(selectedVariant.price.replace(/[^\d.]/g, "")) /
                    Number.parseFloat(selectedVariant.size.replace(/[^\d.]/g, ""))
                  ).toFixed(2)}{" "}
                  por gramo)
                </span>
              )}
